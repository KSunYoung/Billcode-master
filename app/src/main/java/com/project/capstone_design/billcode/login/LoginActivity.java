...
public class LoginActivity extends AppCompatActivity {
    ...
    private com.facebook.login.widget.LoginButton btn_facebook_login; // facebook Login Btn
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layout = (LinearLayout) findViewById(R.id.LoginLayout); // 키보드 숨김 위해서
        ...
        // 카카오 로그인 부분
        btn_kakao_login = (LoginButton) findViewById(R.id.kakao_login_button);
    ...
    private void init() {
        ...
        btn_facebook_login = (com.facebook.login.widget.LoginButton) findViewById(R.id.login_button);//로그인 버튼. 실제 기능 다수가 이 안에 담겨있다.
